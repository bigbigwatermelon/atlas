export const en = {
  ...
  thread: {
    ...
    review: "AI review",
    reviewing: "Reviewing…",
    reviewSkipped: "Review unavailable",
    handle: "Handle",
    reviewPr: "Review PR",
  ...
  lead: {
    ...
    slashHint: "Type / for commands & skills",
  ...
  session: {
    ...
    typingHere: "typing here",
    keymap: "Keyboard ownership",
    keymapDesc: "Weft captures only a few product shortcuts. Everything else passes through to the native TUI.",
    keymapOwner_product: "Product",
    keymapOwner_terminal: "TUI",
    keymapKeyCommand: "⌘K",
    keymapKeyComposer: "⌘↵",
    keymapKeyPanels: "⌘[ / ⌘]",
    keymapKeyInterrupt: "Esc / Ctrl-C",
    keymapKeyPass: "Other keys",
    keymapCommand: "Open the command palette",
    keymapComposer: "Send the composer as one multi-line paste",
    keymapPanels: "Move to the previous / next session panel",
    keymapInterrupt: "Interrupt or stop the current TUI turn",
    keymapPass: "Slash commands, history, completion, and normal typing go to the PTY",
  },
  diff: {
    tab: "Diff",
  ...
  settings: {
    ...
    interface: "Interface",
    theme: "Theme",
    appearanceHint: "Embedded terminals stay dark so native TUI colors remain intact.",
    light: "Light",
    dark: "Dark",
    language: "Language",
    ...
    defaultToolHint: "Default lead tool for new issues. Each issue and sub-task can still override it.",
