export const en = {
  ...
  nav: {
    ...
    renameWorkspace: "Rename task hub",
    ...
    repoMap: "Repo map",
    needsYou: "Needs you",
    otherWorkspaceNeeds: "Another task hub needs you",
    newWorkspace: "New task hub",
  ...
  config: {
    ...
    layer_repo: "repo",
    layer_team: "team",
    "layer_atlas-global": "Atlas · global",
    "layer_atlas-workspace": "Atlas · current environment",
    loading: "Reading config…",
    empty: "No skills or rules found.",
    noRepos: "Add repos first.",
  },
  workspace: {
    tabRepos: "Repos",
  ...
  onboarding: {
    ...
    workspaceBody: "Atlas prepares the current environment for tasks, skills, and local agent sessions automatically.",
    ...
    scopeBody: "One task → which repos change, who does it, and in what order. Atlas infers it; you correct the write set.",
    ...
    body: "Start with one task. When repos are needed, Atlas builds the repo map used to infer scope, dispatch workers, and verify progress.",
    ...
    previewHint: "The core Atlas workflow",
  ...
  scope: {
    ...
    unknownRepo: "not in the current environment — skipped on create",
  ...
  repomap: {
    ...
    emptyBody:
      "Add repos, and the curator profiles each — role, stack, interfaces — and links them into a dependency graph the lead uses to split work.",
  ...
  dialog: {
    newWorkspaceTitle: "New task hub",
    workspaceName: "Name",
    workspaceNamePlaceholder: "Task hub name",
    createWorkspace: "Create task hub",
  ...
  repoActions: {
    ...
    noWorkspaceToast: "Could not prepare tasks",
  },
  slashLocal: {
