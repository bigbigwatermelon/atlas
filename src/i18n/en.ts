export const en = {
  ...
  config: {
    ...
    "layer_weft-workspace": "weft · current environment",
  ...
  onboarding: {
    ...
    workspaceBody: "Weft prepares the current environment for tasks, skills, and local agent sessions automatically.",
    ...
    body: "Start with one task. When repos are needed, Weft builds the repo map used to infer scope, dispatch workers, and verify progress.",
