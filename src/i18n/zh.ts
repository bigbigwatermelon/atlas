export const zh = {
  ...
  workspace: {
    ...
    noActivityBody: "打开一个 issue 并派发任务,这里会显示实时动态。",
  ...
  dialog: {
    ...
    newDirectionTitle: "新建子任务",
    newDirectionDesc: "选择这个子任务要写哪个仓库,并说明原因。它会获得自己的 worktree。",
    directionName: "名称",
    tool: "工具",
    writeRepo: "写仓库",
    writeRepoHint: "这个子任务在独立 worktree 中只写这一个仓库。agent 可自由读取任意仓库,所以不必列出读取项。",
    reason: "原因",
  ...
  settings: {
    ...
    choose: "选择文件夹",
    defaultTool: "默认编程工具",
    defaultToolHint: "新子任务的预选项,每个子任务仍可单独切换。",
    detecting: "检测中…",
    installed: "已安装",
